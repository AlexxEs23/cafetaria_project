    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-blue-700 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-blue-100">Dashboard Mitra</p>
          </div>
          <div className="flex gap-3 items-center">
            <button
              onClick={() => router.push('/dashboard/mitra')}
              className="px-4 py-2 text-sm bg-white text-blue-700 rounded-lg hover:bg-blue-50 font-medium transition-colors"
            >
              ← Kembali
            </button>
            <button
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filterMode === 'single' && dailyReport ? (
          <>
            {/* Day Info */}
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg shadow-md p-6 mb-8">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-sm mb-1">Laporan Tanggal</p>
                ...
                <div className="text-right">
                  <p className="text-blue-100 text-sm mb-1">Total Penjualan</p>
                  <p className="text-4xl font-bold">{formatCurrency(dailyReport.totalSales)}</p>
                  <p className="text-blue-100 mt-1">{dailyReport.transactionCount} Transaksi</p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={dailyReport.hourlyDistribution}>
                    ...
                    <Legend />
                    <Bar dataKey="sales" name="Penjualan" fill="#2563eb" radius={[8, 8, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
